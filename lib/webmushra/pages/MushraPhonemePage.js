...
MushraPhonemePage.prototype.unfreeze = function () {
  ...
  $.mobile.activePage.find(selector).focus();
  $(selector).attr("active", "true");
  // TODO: freeze the "setLoop" markers. how do we do this?
  this.waveformVisualizer.slider('disable') // ain't working
  this.waveformVisualizer.slider.attr("active", "false"); // ain't working
